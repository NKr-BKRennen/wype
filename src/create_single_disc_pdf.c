...
int create_disc_pdf_pages( wype_context_t* ptr )
{
    ...
    pdf_add_text( pdf, NULL, "Device hostname:", 12, 300, 510, PDF_GRAY );
     ...
     */
    {
        ...
        pdf_add_rectangle( pdf, NULL, 60, cb_y - 12, cb_size, cb_size, 1, PDF_BLACK );
        pdf_add_text( pdf, NULL, "Returned to customer", text_size_data, 75, cb_y - 12, PDF_BLACK );
        ...
        pdf_add_line( pdf, NULL, 295, cb_y - 4, 445, cb_y - 4, 1, PDF_BLACK );
    }
     ...
     */
    {
        ...
        pdf_add_line( pdf, NULL, 50, 57, 550, 57, 3, PDF_BLACK );
